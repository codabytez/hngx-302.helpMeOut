import videoRepo from "../assets/Video_Repository.jpg";

const FeaturesSection = () => {
  return (
    <>
      <div className="flex py-20 flex-col justify-center items-center gap-16 bg-white">
        <div className="flex flex-col justify-center items-center gap-2">
          <h2 className="text-[#141414] self-stretch text-center font-sora text-[40px] font-bold leading-normal">
            Features
          </h2>
          <p className="self-stretch text-[#616163] text-center font-sans text-xl leading-[30.26px]">
        ...
        <div className="flex items-center gap-14">
          <div className="flex flex-col items-start justify-center gap-12 self-stretch">
            <div className="flex items-start gap-4 self-stretch">
              <div className="flex p-2 justify-center items-center rounded-[30px] bg-[#413c6d]">
                <svg
              ...
              <div className="flex flex-col items-start gap-3 flex-1">
                <div className="flex flex-col items-start gap-2 self-stretch">
                  <h4 className="self-stretch color-[#1b233d] font-inter text-[28px] font-semibold leading-normal">
                    Simple Screen Recording
                  </h4>
                  <p className="self-stretch text-[#616163] font-workSans text-xl leading-[30.26px]">
          ...
          <img src={videoRepo} alt="Video Repository" className="rounded-lg" />
        </div>
      </div>
    </>
  );
